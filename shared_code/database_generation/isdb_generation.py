...
Due to the large number of files, a demo is provided here('./data')
...
if __name__ =='__main__':
    ...
    for row in tqdm(data,total=len(data)):
        ...
        ids.append(row[0])
        smiles.append(row[1])
    with open('./data/isdb_info.json', 'w') as f: #
    ...
    for i in trange(len(MS1_library_df.index)):
        try:
            ...
            pass
    MS1_library_df.to_csv('./data/isdbMS1.csv',index=None)
